#  Plot the lifetime reproductive success of Hutt

plot_lrs_distr_hutt <- function(distr, theoretic_distri, n= 15){
  ...
  lines(theoretic_distri$mids, theoretic_distri$density, xlab = "Number of offspring (LRS)", ylab = "Probablity",
        lty = 3)
  text(lrs.mean, max(distr$density)*0.095, lrs.mean, col = "darkgray", cex = 0.85)
